 ...
 *
 */
public class RNASecondaryStructureInputFileException extends Exception {
	 ...
	 * 
	 */
	public RNASecondaryStructureInputFileException() {
	}

	/**
	 * @param message Description message
	 */
	public RNASecondaryStructureInputFileException(String message) {
		super(message);
	}
	 ...
	 */
	public RNASecondaryStructureInputFileException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause Cause of the exception
	 */
	public RNASecondaryStructureInputFileException(String message, Throwable cause) {
		super(message, cause);
	}
