...
public interface CommandLineMessages {
    ...
    public static String USAGE_EXAMPLES_WB = "Usage examples:\n\n>"
	    ...
	    + "ASPRA Distance between the two structures and execution time "
	    + "information.\n\n" + LAUNCH_COMMAND_WB
	    + " -f TestWorkBench1 -o "
    ...
    public static String LAUNCH_COMMAND_FE = "java -jar ASPRAlignWorkbenchFeaturesExtractor.jar";
    // TODO modificare stringhe _WB
