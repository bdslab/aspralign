 ...
 *
 */
public class StructuralRNATreeAlignResult {
	 ...
	 */
	public StructuralRNATreeAlignResult(Tree<String> t1, Tree<String> t2) throws TreeAlignException {
		this.t1 = t1;
		this.t2 = t2;
		ScoringFunction sf = new ScoringFunction();
		TreeAlign<String, String> al = new TreeAlign<>(sf);
