...
/**
 * Container class for the static method to read an RNA secondary structure from
 * a file using ANTLR 4.
 * 
 * @author Luca Tesei
 *
 */
public class RNASecondaryStructureFileReader {
	...
	/**
	 * Use ANTLR 4 and the grammar defined for RNA Secondary Structures to read a
	 * secondary structure from a file.
	 * 
	 * @param fileName       the name of the file to read
	 * @param basePairsCheck flag to indicate if the base pairs should be checked
	 * @throws IOException                 if the specified file cannot be read
	 * @throws RNAInputFileParserException if the file contains lexical or syntax
	 *                                     errors in the definition of the secondary
	 *                                     structure
	 */
	public static RNASecondaryStructure readStructure(String fileName, boolean basePairsCheck) throws IOException {
		...
		// add an error listener that throws an RNAInputFileParserException upon syntax errors
		structureParser.addErrorListener(new RNASecondaryStructureFileReaderErrorListener());
